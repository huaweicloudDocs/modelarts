# 查询导入任务状态<a name="modelarts_04_0344"></a>
...
## 示例代码<a name="section1997644471710"></a>
...
task_info = dataset.get_import_task_info(task_id="r4R52nJ4VJKcivuioCU")
```
...
<td class="cellrowborder" valign="top" width="54.72%" headers="mcps1.2.5.1.4 "><p id="p5601639154814"><a name="p5601639154814"></a><a name="p5601639154814"></a>导入任务的任务ID。</p>
</td>
</tr>
</tbody>
</table>
