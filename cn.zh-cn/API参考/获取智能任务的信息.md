# 获取智能任务的信息<a name="AutoAnnotationProgress"></a>

## 功能介绍

获取智能任务的详细信息，支持查询“智能标注”、“一键模型上线”和“自动分组”三大类智能任务。可通过指定路径参数“task\_id”来查询某个具体任务的详情。

## URI

GET /v2/\{project\_id\}/datasets/\{dataset\_id\}/tasks/\{task\_id\}
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>任务运行状态码。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>任务的运行信息。</p>
</td>
</tr>
