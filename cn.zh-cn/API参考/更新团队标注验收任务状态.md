# 更新团队标注验收任务状态<a name="UpdateWorkforceSamplingTask"></a>
...
PUT /v2/\{project\_id\}/datasets/\{dataset\_id\}/workforce-tasks/\{workforce\_task\_id\}/acceptance/status
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>验收行为。可选值如下：</p>
<ul><li><p>0：通过全部样本</p>
</li><li><p>1：驳回全部样本</p>
</li><li><p>2：取消验收</p>
</li><li><p>3：查看验收冲突的样本列表</p>
</li><li><p>4：只通过单张验收通过的样本及未验收的样本</p>
</li><li><p>5：只通过单张验收通过的样本</p>
</li></ul>
</td>
</tr>
...
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>overwrite_last_result</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.2 "><p>否</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>Boolean</p>
</td>
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>是否覆盖已标注数据。可选值如下：</p>
<ul><li><p>true：覆盖已标注数据</p>
</li><li><p>false：不覆盖已标注数据（默认值）</p>
</li></ul>
</td>
</tr>
</tbody>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>验收样本的总数目。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>验收样本的列表。</p>
</td>
</tr>
</tbody>
</table>

**表 5**  DescribeSampleResp
