# 更新标注团队<a name="UpdateWorkforce"></a>
...
PUT /v2/\{project\_id\}/workforces/\{workforce\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>标注团队的名称，1~64长度，只能包含字母、数字、中划线和下划线。</p>
</td>
</tr>
</tbody>
</table>
