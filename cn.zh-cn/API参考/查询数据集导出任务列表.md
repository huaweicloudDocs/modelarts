# 查询数据集导出任务列表<a name="GetExportTasksStatusOfDataset"></a>
...
GET /v2/\{project\_id\}/datasets/\{dataset\_id\}/export-tasks
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>export_type</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.2 "><p>否</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>导出类型，不传则默认查询所有类型的导出任务。可选值如下：</p>
<ul><li><p>0：已标注</p>
</li><li><p>1：未标注</p>
</li><li><p>2：全部</p>
</li><li><p>3：条件筛选</p>
...
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>export_tasks</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_ExportTaskStatusResp">ExportTaskStatusResp</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>导出任务列表。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>导出任务的总数量。</p>
</td>
</tr>
...
**表 4**  ExportTaskStatusResp

<a name="response_ExportTaskStatusResp"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p>参数类型</p>
</th>
