# 查询智能标注的样本列表<a name="ListAutoAnnotationSamples"></a>
...
GET /v2/\{project\_id\}/datasets/\{dataset\_id\}/auto-annotations/samples
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>high_score</p>
</td>
