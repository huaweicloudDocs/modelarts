...
POST /v2/\{project\_id\}/datasets/\{dataset\_id\}/data-annotations/labels
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>待创建的标签列表。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>创建标签响应体。</p>
</td>
</tr>
