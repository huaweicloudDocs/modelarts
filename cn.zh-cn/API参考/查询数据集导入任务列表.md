# 查询数据集导入任务列表<a name="ListImportTasks"></a>
...
GET /v2/\{project\_id\}/datasets/\{dataset\_id\}/import-tasks
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>import_tasks</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_ImportTaskStatusResp">ImportTaskStatusResp</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>导入任务列表。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>导入任务的数量。</p>
</td>
</tr>
</tbody>
</table>

**表 4**  ImportTaskStatusResp

<a name="response_ImportTaskStatusResp"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p>参数类型</p>
</th>
