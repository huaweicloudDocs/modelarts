# 分页查询团队标注任务下的样本列表<a name="ListWorkforceTaskSamples"></a>
...
GET /v2/\{project\_id\}/datasets/\{dataset\_id\}/workforce-tasks/\{workforce\_task\_id\}/data-annotations/samples
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>label_name</p>
</td>
