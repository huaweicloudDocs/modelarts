# 查询数据集导出任务的状态<a name="GetExportTaskStatusOfDataset"></a>
...
GET /v2/\{project\_id\}/datasets/\{resource\_id\}/export-tasks/\{task\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>资源ID，当前支持传数据集ID。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>导出任务ID。</p>
</td>
</tr>
</tbody>
</table>
