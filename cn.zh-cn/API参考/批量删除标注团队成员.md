# 批量删除标注团队成员<a name="DeleteWorkers"></a>
...
POST /v2/\{project\_id\}/workforces/\{workforce\_id\}/workers/batch-delete
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>团队成员ID列表。</p>
</td>
</tr>
</tbody>
</table>
