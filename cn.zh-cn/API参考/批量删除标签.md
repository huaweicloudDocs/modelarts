...
POST /v2/\{project\_id\}/datasets/\{dataset\_id\}/data-annotations/labels/delete
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>delete_policy</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.2 "><p>否</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>是否删除标签及包含标签的样本。可选值如下：</p>
<ul><li><p>0：只删除标签</p>
</li><li><p>1：删除标签及包含标签的样本</p>
</li><li><p>2：删除标签和包含标签的样本及其源文件</p>
</li></ul>
</td>
</tr>
</tbody>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>待删除标签列表。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>删除标签响应体。</p>
</td>
</tr>
